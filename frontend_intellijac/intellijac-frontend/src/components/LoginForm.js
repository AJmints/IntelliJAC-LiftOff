...
export default class LoginForm extends React.Component {
  ...
  onSubmit = (e) => {
    ...
    if (isRegistering) {
      this.props.onRegister(e, firstName, lastName, username, password);
    } else {
      this.props.onLogin(e, username, password);
    }
...
//
//  render() {
//    const { isRegistering, submittedSuccessfully } = this.state;
//
//    return (
//      <div className="login-form-container">
//        <div className="button-container">
